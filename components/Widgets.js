  ...
  return (
    <div className="xl:w-[600px]  hidden lg:inline ml-8 space-y-5">
        <div className="w-[90%] xl:w-[75%] sticky top-0 bg-white py-1.5 z-50  ">
            {/* SearchIcon and placeholder styling||Search Twitter */}
        ...
        <div className="text-gray-700 space-y-3 bg-gray-100 rounded-xl pt-2 w-[90%] xl:w-[75%]">
          ...
          <button onClick={()=>setArticleNum(articleNum+3)} className="text-blue-300 pl-4 hover:text-blue-400">Show more</button>
             ...
             <h4 className="font-bold text-xl px-4">Who to follow</h4>
              ...
              <div key={randomUser.login.username} className="flex items-center px-4 py-2 curser-pointer hover:bg-gray-200">
                <img
